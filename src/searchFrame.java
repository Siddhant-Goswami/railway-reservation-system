...
public class searchFrame extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sleeper", "1st AC", "2nd AC", "3rd AC" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Train Name", "Departure Time", "Sleeper Seats Available", "1st AC Seats Available", "2nd ACSeats Available", "3rd AC Seats Available"
            }
        ) {
        ...
        jLabel2.setText("Select Train from search list for booking process");
        ...
        jLabel3.setText("sleeper/1st AC/2nd AC/3rd AC");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try
        {
            ...
            {
                JOptionPane.showMessageDialog(this, "Please Select train from List");
            }
            else
            {
